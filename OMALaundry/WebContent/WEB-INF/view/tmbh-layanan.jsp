...
<h2 class="title" align="center">Tambah Admin</h2><br>
 <form action="prosesDaftar" method="POST" modelAttribute="model">
    ...
    <div  class="d-flex justify-content-center align-items-center container ">
     <input class="input--style-2" type="text" placeholder="Harga" name="harga">
    </div><br>
    
    <div  class="d-flex justify-content-center align-items-center container ">
     <input class="input--style-2" type="text" placeholder="Keterangan" name="keterangan">
    </div><br>
    
    <div  class="d-flex justify-content-center align-items-center container ">
     <input class="input--style-2" type="text" placeholder="Durasi" name="durasi">
    </div><br>
